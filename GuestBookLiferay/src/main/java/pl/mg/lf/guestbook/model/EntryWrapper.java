...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
    ...
    */
    ...
    @Override
    public int compareTo(pl.mg.lf.guestbook.model.Entry entry) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<pl.mg.lf.guestbook.model.Entry> toCacheModel() {
        return _entry.toCacheModel();
    }

    @Override
    public pl.mg.lf.guestbook.model.Entry toEscapedModel() {
        return new EntryWrapper(_entry.toEscapedModel());
    }

    @Override
    public pl.mg.lf.guestbook.model.Entry toUnescapedModel() {
