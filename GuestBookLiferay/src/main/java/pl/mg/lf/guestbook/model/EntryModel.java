 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link pl.mg.lf.guestbook.model.impl.EntryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link pl.mg.lf.guestbook.model.impl.EntryImpl}.
 * </p>
 *
 * @author mg
 * @see Entry
 * @see pl.mg.lf.guestbook.model.impl.EntryImpl
 * @see pl.mg.lf.guestbook.model.impl.EntryModelImpl
 * @generated
 */
public interface EntryModel extends BaseModel<Entry>, StagedGroupedModel,
    ...
    @Override
    public CacheModel<pl.mg.lf.guestbook.model.Entry> toCacheModel();
