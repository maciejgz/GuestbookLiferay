...
import pl.mg.lf.guestbook.NoSuchEntryException;
import pl.mg.lf.guestbook.model.Entry;
import pl.mg.lf.guestbook.model.impl.EntryImpl;
import pl.mg.lf.guestbook.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
    ...
    @Override
    public Entry updateImpl(pl.mg.lf.guestbook.model.Entry entry)
        throws SystemException {
        entry = toUnwrappedModel(entry);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.pl.mg.lf.guestbook.model.Entry")));
