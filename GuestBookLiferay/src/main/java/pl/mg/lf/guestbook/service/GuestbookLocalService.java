package pl.mg.lf.guestbook.service;
 ...
 * @see pl.mg.lf.guestbook.service.impl.GuestbookLocalServiceImpl
 * @generated
 */
...
public interface GuestbookLocalService extends BaseLocalService,
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link GuestbookLocalServiceUtil} to access the guestbook local service. Add custom service methods to {@link pl.mg.lf.guestbook.service.impl.GuestbookLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
    ...
    */
    ...
    public pl.mg.lf.guestbook.model.Guestbook addGuestbook(
    ...
    */
    public pl.mg.lf.guestbook.model.Guestbook createGuestbook(long guestbookId);
    ...
    */
    ...
    public pl.mg.lf.guestbook.model.Guestbook deleteGuestbook(long guestbookId)
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.DELETE)
    public pl.mg.lf.guestbook.model.Guestbook deleteGuestbook(
        pl.mg.lf.guestbook.model.Guestbook guestbook)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    ...
    public pl.mg.lf.guestbook.model.Guestbook fetchGuestbook(long guestbookId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public pl.mg.lf.guestbook.model.Guestbook fetchGuestbookByUuidAndCompanyId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public pl.mg.lf.guestbook.model.Guestbook fetchGuestbookByUuidAndGroupId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public pl.mg.lf.guestbook.model.Guestbook getGuestbook(long guestbookId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public pl.mg.lf.guestbook.model.Guestbook getGuestbookByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public pl.mg.lf.guestbook.model.Guestbook getGuestbookByUuidAndGroupId(
        java.lang.String uuid, long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<pl.mg.lf.guestbook.model.Guestbook> getGuestbooks(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
    public pl.mg.lf.guestbook.model.Guestbook updateGuestbook(
        pl.mg.lf.guestbook.model.Guestbook guestbook)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    ...
    public pl.mg.lf.guestbook.model.Guestbook addGuestbook(long userId,
        java.lang.String name,
        com.liferay.portal.service.ServiceContext serviceContext)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;

    public pl.mg.lf.guestbook.model.Guestbook updateStatus(long userId,
